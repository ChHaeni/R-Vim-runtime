...
" Comment
syn match rCommentTodo contained "\(BUG\|FIXME\|NOTE\|TODO\|XXX\|OPTIMIZE\|HACK\|QUESTION\|Q\|A\|OPEN\):"
syn match rTodoParen contained "\(BUG\|FIXME\|NOTE\|TODO\|XXX\|OPTIMIZE\|HACK\|QUESTION\|Q\|A\|OPEN\)\s*(.\{-})\s*:" contains=rTodoKeyw,rTodoInfo transparent
syn keyword rTodoKeyw BUG FIXME NOTE TODO XXX OPTIMIZE HACK QUESTION Q A OPEN contained
