...
if exists("g:r_syntax_folding")
  ...
  syn region rSection1 matchgroup=Title start=/^\s*#.*[-]\{4,}/ end=/^\s*#.*[-]\{4,}/ms=s-2,me=s-1 transparent contains=ALL,rTodoKeyw,rTodoParen,rTodoInfo,rCommentTodo fold
  syn region rSection2 matchgroup=Title start=/^\s*#.*[=]\{4,}/ end=/^\s*#.*[=]\{4,}/ms=s-2,me=s-1 transparent contains=ALL,rTodoKeyw,rTodoParen,rTodoInfo,rCommentTodo fold
  syn region rSection3 matchgroup=Title start=/^\s*#.*[#]\{4,}/ end=/^\s*#.*[#]\{4,}/ms=s-2,me=s-1 transparent contains=ALL,rTodoKeyw,rTodoParen,rTodoInfo,rCommentTodo fold
  syn region rSection4 matchgroup=Title start=/^\s*#.*[~]\{4,}/ end=/^\s*#.*[~]\{4,}/ms=s-2,me=s-1 transparent contains=ALL,rTodoKeyw,rTodoParen,rTodoInfo,rCommentTodo fold
else
